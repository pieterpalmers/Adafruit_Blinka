...
class SPI:
    ...
    def __init__(self):
        ...
        self._spi.configure("ftdi://ftdi:ft2232h/1")
        self._port = self._spi.get_port(0)
        self._port.set_frequency(100000)
        self._port._cpol = 0
        self._port._cpha = 0
        # Change GPIO controller to SPI
        Pin.ft2232h_gpio = self._spi.get_gpio()
    ...
    def init(
        ...
        if phase != 0:
            raise ValueError("Only SPI phase 0 is supported by FT2232H.")
